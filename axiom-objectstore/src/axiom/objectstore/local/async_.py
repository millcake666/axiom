"""axiom.objectstore.local.async_ — Async local disk object storage client."""
...
class AsyncLocalDiskObjectStore(AbstractAsyncObjectStore):
    """Async local disk object storage client using aiofiles.
    ...
    def __init__(self, config: LocalDiskConfig) -> None:
        """Initialise the async local disk client.
