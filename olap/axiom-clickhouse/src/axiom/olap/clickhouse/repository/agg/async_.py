# ruff: noqa: S608
"""axiom.olap.clickhouse.repository.agg.async_ — Asynchronous aggregation ClickHouse repository."""
...
class AsyncClickHouseAggRepository(AsyncClickHouseBaseRepository):
    """Asynchronous aggregation repository for ClickHouse analytical queries."""
    ...
    async def aggregate(
        ...
        """Execute an aggregation query asynchronously from a full AggregateSpec.
    ...
    async def count_by(
        ...
        """Count rows grouped by specified fields asynchronously.
        ...
        return await self._fetch_all(query, params or None)
    ...
    async def sum_by(
        ...
        """Sum a numeric field grouped by specified fields asynchronously.
    ...
    async def top_n(
        ...
        """Fetch the top N values of a field by a given metric asynchronously.
    ...
    async def time_series(
        ...
        """Execute a time-series aggregation query asynchronously.
    ...
    async def execute_analytical(
        self,
        query: str,
        params: dict[str, Any] | None = None,
        settings: dict[str, Any] | None = None,
    ) -> AggregateResult:
        """Execute a raw analytical query asynchronously.
